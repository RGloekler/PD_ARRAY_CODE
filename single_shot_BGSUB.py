...
def main():
    ...
    while True:
        ...
        if len(line) > 2: # get only proper pixel data from serial
            ...
            #bg_vals = [0.002600196,0.076774194,0.077556207,0.028670577,0.002424242,0,0.000371457,0.051104594,0.085278592,0.110215054,0.011612903,0.005679374,0.09914956,0.0028348,0.105493646,0.082091887]
            ...
            if counter % 100 == 0:
                ...
                print('Final data transfer, processing, and csv write time is: ' + str(final_time - recieved_time))
